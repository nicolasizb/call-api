...
router.post('/call', async (req, res) => {
    ...
    try {
        ...
        // Crear una promesa que se resolverá cuando se presione un dígito
        const digitPressedPromise = new Promise(resolve => {
            router.post('https://call-api-phi.vercel.app/validation', (req, res) => {
                ...
                resolve(digitPressed)
            })
        })

        // Esperar a que se resuelva la promesa
        const digitPressed = await digitPressedPromise
